...
string rootFolder = Path.Combine(Environment.CurrentDirectory.Split(".ci")[0]); //Assumes the git folder is in the parent directory of the APIGenerator folder
...
foreach (Assembly assembly in assemblies)
{
    ...
    Generate.GenerateAssembly(assembly);
}
